...
import { ColectionList } from './ColectionList/ColectionList'
...
const Colections = ({ activeColection, setActiveColection }) => {
    ...
    useEffect(() => {
        if (loading) return;
        setCreatedColections(colections.sort((a, b) => a.order - b.order))
    }, [colections, loading])
    ...
    console.log("createdColections", createdColections)
